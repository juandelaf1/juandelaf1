...
- **Business perspective**: 7+ years in operations — sales, costs, margins, efficiency
- **Analytical rigor**: clean ETL pipelines, validated data, clear KPIs
- **Execution mindset**: if data is missing, I find it; if something breaks, I fix it
- **Full stack**: from extraction to dashboard, including APIs and tests
